...
import { DelCategoryRequest } from "../../../redux/action/master/categoryAction";
...
export default function DeleteCategory(props: any) {
  ...
  const deleteModal = () => {
    dispatch(DelCategoryRequest(props.id));
              ...
              <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
                ...
                <div className="relative p-6 flex-auto">
                  <p className="my-4 text-slate-500 text-lg leading-relaxed">
                    Are you sure you want to delete category {props.name}
                  </p>
                </div>
                {/*footer*/}
