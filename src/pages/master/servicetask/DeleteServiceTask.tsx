...
import { DelServiceTasksRequest } from "../../../redux/action/master/serviceTasksAction";
import { useDispatch } from "react-redux";

export default function DeleteServiceTask(props: any) {
  const [showModal, setShowModal] = useState(false);
  const dispatch = useDispatch();

  const deleteModal = () => {
    dispatch(DelServiceTasksRequest(props.id));
