...
// import { GetDeptRequest, GetDeptSuccess, GetDeptFailed, DeleteDeptRequest, DeleteDeptSuccess, DeleteDeptFailed } from '../../../redux/action/hr/departmentAction'

// export default function HRDepartment() {
 
//     // define API GET department
//     const { departments, messageError } = useSelector(
//       (state: any) => state.deptState
//     );
...
//     const tableData = Array.isArray(dataDepartment) ? dataDepartment.length > 0 ? dataDepartment : departments : departments;
//     const countedData = departments.count;
//     /* counting data and assign to table */
...
//     setDataDepartment(departments.data)
//   }, []);
...
//     setDataDepartment([]);
//     dispatch(DeleteDeptRequest({deptId : deptId, page: page}))
//   };
...
//     },
//     {
//       title: [<PlusOutlined key="plus-icon" />, <Button key="add-button" type="text" onClick={() => showModal("Add")} > Add </Button>],
//       dataIndex: 'Action',
//       key: 'action',
...
//     axios.get(`http://localhost:3002/department/`)
//       .then((response) => {
//         // get response
//         setLoading(false)
//         // set dataDepartment
...
//         dispatch(GetDeptSuccess(response.data))
