...
export default function AddPhoto(props: any) {
  ...
  return (
    <>
      ...
      {showModal ? (
        <>
          <div className=" my-10 justify-center items-center flex  fixed inset-0 z-50 outline-none focus:outline-none">
            <div className="relative w-2/4 my-6 mx-auto max-w-3xl max-h-full overflow-y-scroll">
              {/*content*/}
