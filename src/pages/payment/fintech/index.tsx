...
import { GetPaymentGatewayRequest, DeletePaymentGatewayRequest } from "../../../redux/action/payment/paymentGatewayAction";
        ...
        {rowData.pagaEntityId === id && kebabMenu && (
          <div className="absolute top-10 border-coldBlue text-coldBlue w-96 ">
            <ul className="bg-white z-40 absolute right-3  border-coldBlue border-solid border-2 rounded-md text-center">
              ...
              <li>
                <button onClick={() => onDelete(rowData.pagaEntityId)} className="p-3 hover:bg-coldBlue hover:text-white w-full">
                  Delete
                </button>
              </li>
            </ul>
