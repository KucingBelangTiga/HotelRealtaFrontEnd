...
import * as FacilityType from '../constant/hotel/facilityConstant'
...
import { handlePohe, DeletePohe, EditPohe, createPohe, getAllPohe } from "./purchasing/poheSaga";
...
import { handleFacility } from "./hotel/facilitySaga";
...
function* watchAll() {
    yield all([
        ...
        takeEvery(PoheType.GETALL_POHE_REQUEST, getAllPohe),
        ...
        takeEvery(FacilityType.GET_FACILITY_REQUEST, handleFacility)
    ])
}
